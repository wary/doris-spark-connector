...
public class DorisOptions {
	...
	public static final ConfigOption<String> DORIS_READ_FLIGHT_SQL_INIT_SQL = ConfigOptions.name("doris.read.arrow-flight-sql.init.sql").stringType().withoutDefaultValue().withDescription("");
